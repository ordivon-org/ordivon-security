...
This closes the **current 目标产品B Case only**. P1 itself remains a candidate infrastructure track: the observation profile is defined, but the generic Guest observer and third-party installer execution backend are not implemented or admitted.

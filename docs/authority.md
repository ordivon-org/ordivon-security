...
- [`UNPUBLISHED-COMPLETION-C1H.md`](UNPUBLISHED-COMPLETION-C1H.md) owns the completed-but-unpublished consequence experiment, completion/publication/executor separation, read-only sensor methodology correction, publication-only successor repair, and resulting observationally-indistinguishable one-shot pressure.

...
- [`WORLD-ENTITY-MIGRATION-RECOVERY.md`](WORLD-ENTITY-MIGRATION-RECOVERY.md) owns the deterministic and physical controller-loss Entity KVM recovery baseline: predecessor ownership is never rewritten, unpublished native states remain observation-only `UNKNOWN`, and Entity successor continuation remains unproven.

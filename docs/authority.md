...
- [`MID-SUCCESSOR-RECOVERY-C1G.md`](MID-SUCCESSOR-RECOVERY-C1G.md) owns the successor-mid-continuation SIGKILL experiment, same-ledger/different-world falsifier, post-acquisition world re-observation rule, same-Guest two-controller-death continuity proof, and resulting unpublished-completion pressure.

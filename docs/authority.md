...
- [`INTRINSIC-IDEMPOTENCY-C1K.md`](INTRINSIC-IDEMPOTENCY-C1K.md) owns the exact ensure-state consequence experiment, repeated-invocation/single-semantic-consequence result, preexisting-invariant semantics, fail-closed resource identity boundary, and resulting compensation pressure.

...
- [`FRESH-CONTROLLER-CONTINUATION-C1D.md`](FRESH-CONTROLLER-CONTINUATION-C1D.md) owns the first physical successor-continuation experiment, world-state-as-progress result, same-Guest continuity proof, non-restoration of the old Range object/event stream, and the resulting durable successor-ownership race.

...
- [`RECIPIENT-COMMIT-GAP-C1J.md`](RECIPIENT-COMMIT-GAP-C1J.md) owns the recipient consequence/dedup dual-order fault injection, duplicate-versus-loss result, durable `reserved` inbox ambiguity proof, and resulting pressure for intrinsic idempotency or a genuine shared atomic boundary.

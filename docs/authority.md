...
- [`INFORMATION-LOSS-C1I.md`](INFORMATION-LOSS-C1I.md) owns the delivered-versus-undelivered indistinguishability experiment, `UNKNOWN` epistemic boundary, blind-retry falsifier, restricted-principal recipient-state separation, recipient-side exact-effect deduplication result, and resulting recipient commit-gap pressure.

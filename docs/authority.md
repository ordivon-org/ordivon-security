...
- [`COMPENSATION-C1L.md`](COMPENSATION-C1L.md) owns the non-idempotent duplicate/compensation experiment, blind-compensation-retry falsifier, original-versus-compensation identity separation, repair-invariant re-observation rule, and resulting unobservable-compensation pressure.

...
- [`SUCCESSOR-OWNERSHIP-C1E.md`](SUCCESSOR-OWNERSHIP-C1E.md) owns the physical successor-versus-reconciler race falsifier, predecessor-provenance/current-recovery-authority separation, exact-generation successor claim, per-Run kernel arbitration mechanism, successor-SIGKILL release proof, and resulting multiple-successor pressure.

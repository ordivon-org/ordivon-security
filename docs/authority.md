...
- [`MULTIPLE-SUCCESSORS-C1F.md`](MULTIPLE-SUCCESSORS-C1F.md) owns the two-successor competition, non-mutating loser proof, current-generation retry/adoption result, persistent-consequence versus transient-service distinction, overwrite-lineage falsifier, archived predecessor-claim mechanism, and resulting mid-succession interruption pressure.

...
Falsifiers: a later independent consumer requires cross-episode state or opponent/resource history that materially changes decisions beyond current observation + ordinary trajectory; or a narrow shared provider binding measurably improves tactical performance where direct effect interfaces fail.

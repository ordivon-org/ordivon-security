...
C1-I closes the next information-loss pressure at `3241eb91e025dbb4770cf7e4b87cd743bf0157be`. A delivered local vanishing pulse and an undelivered history produced the exact same durable sender digest `sha256:208cb48c1c39f1267385f2245a536e4174f2a8c3c1fa707689d67ac3e30050d0` and the same post-crash successor-view digest `sha256:7d2abd6480fc8d112b63f385d5257541d0c20a8ea6ec5b59271aabcce1d0b2cc`; both therefore classified `UNKNOWN`. A UID-65534 blind retry then physically produced two total pulses in the already-delivered history versus one in the never-delivered history. The minimal tested alternative was recipient-owned durable exact-effect dedup: UID 65534 could not read the private record but could resend the public effectId; delivered retry was `duplicate-suppressed`, undelivered retry was `applied`, and both converged to applicationCount=1 with acknowledgement suitable for sender completion. This distinguishes historical certainty from safe continuation and moves the next pressure into the recipient commit gap between real consequence and durable dedup persistence.

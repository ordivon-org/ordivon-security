...
The next sequence remains provider-first rather than gateway-first: CA4 now pressures classical Blue observation/detection/adjudication/response. Only repeated binding friction across CA1-CA4 may admit a shared Security provider seam in CA5. Existing `RangeEffectRequest`, Harness Tool composition, Runtime execution, and provider-specific adapters remain the simpler baseline.

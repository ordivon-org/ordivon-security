...
- **Open research:** AF2 provides the reusable zero-or-more Range-intent surface. AF3 separates communicated claim from independent truth. AE0 shows `UNKNOWN` can trigger information acquisition; AE1 carries it through costly waiting; AE2 resolves conflicting independent sensor evidence through explicit adjudication. AE3 removes adjudication: a shared Defender can still make a bounded consequence choice without converting action into truth, but identical evidence across healthy/compromised worlds implies unavoidable counterfactual regret and does not determine one risk-optimal action. The physical Agent also exposed an invalid implicit `50/50` prior, making decision basis—not Trust—the next structural question. Raw verified source history should be tested before any durable Trust/Reputation primitive; C1-O remains parked until stale-but-integrity-valid evidence appears. [`docs/AGENT-FIRST-INTENT-AF2.md`](docs/AGENT-FIRST-INTENT-AF2.md), [`docs/AGENT-FIRST-DECEPTION-AF3.md`](docs/AGENT-FIRST-DECEPTION-AF3.md), [`docs/ADVERSARIAL-EPISTEMICS-AE0.md`](docs/ADVERSARIAL-EPISTEMICS-AE0.md), [`docs/ADVERSARIAL-EPISTEMICS-AE1.md`](docs/ADVERSARIAL-EPISTEMICS-AE1.md), [`docs/ADVERSARIAL-EPISTEMICS-AE2.md`](docs/ADVERSARIAL-EPISTEMICS-AE2.md), and [`docs/ADVERSARIAL-EPISTEMICS-AE3.md`](docs/ADVERSARIAL-EPISTEMICS-AE3.md) define the accepted boundary.

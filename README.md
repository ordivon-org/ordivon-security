...
- **Open research:** AF2 provides the reusable zero-or-more Range-intent surface. AF3 separates communicated claim from independent truth. AE0–AE2 establish information acquisition, costly waiting, and explicit adjudication under `UNKNOWN`. AE3 exposes unavoidable regret and an invented prior when adjudication disappears. AE3-B falsifies the sufficiency of raw source history in ordinary context: aggregation and reasoning→effect alignment are unstable. AE3-C then reuses the exact raw histories and adds only a deterministic reconstructable factual projection; both A-history replicates quarantine and both B-history replicates hold, with reducer facts and structured effect intent aligned. This shifts the next pressure toward generic provenance-bound evidence computation rather than Security-owned Trust/Reputation. C1-O remains parked until stale-but-integrity-valid evidence appears. [`docs/AGENT-FIRST-INTENT-AF2.md`](docs/AGENT-FIRST-INTENT-AF2.md), [`docs/AGENT-FIRST-DECEPTION-AF3.md`](docs/AGENT-FIRST-DECEPTION-AF3.md), [`docs/ADVERSARIAL-EPISTEMICS-AE0.md`](docs/ADVERSARIAL-EPISTEMICS-AE0.md), [`docs/ADVERSARIAL-EPISTEMICS-AE1.md`](docs/ADVERSARIAL-EPISTEMICS-AE1.md), [`docs/ADVERSARIAL-EPISTEMICS-AE2.md`](docs/ADVERSARIAL-EPISTEMICS-AE2.md), [`docs/ADVERSARIAL-EPISTEMICS-AE3.md`](docs/ADVERSARIAL-EPISTEMICS-AE3.md), [`docs/ADVERSARIAL-EPISTEMICS-AE3B.md`](docs/ADVERSARIAL-EPISTEMICS-AE3B.md), and [`docs/ADVERSARIAL-EPISTEMICS-AE3C.md`](docs/ADVERSARIAL-EPISTEMICS-AE3C.md) define the current boundary.

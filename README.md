...
- **Open research:** AF2 provides a physically consumed zero-or-more Range-intent surface without Contest ticks. AF3 separates communicated claim from complete independent truth. AE0 shows `UNKNOWN` can trigger explicit information acquisition. AE1 keeps that truth pending across a real, costly decision opportunity: one autonomous false claim is frozen across two counterfactual worlds, one shared pre-truth Defender policy inspects and then holds while truth remains unavailable, and only later world truth separates hold from quarantine. Trust/Reputation, freshness and reversible containment remain unforced. The next pressure is conflicting independently sourced truth; repeated interaction, collusion, infection and strategic conflict remain later consumers, while C1-O stays parked until a real stale-evidence consumer reaches it. [`docs/AGENT-FIRST-INTENT-AF2.md`](docs/AGENT-FIRST-INTENT-AF2.md), [`docs/AGENT-FIRST-DECEPTION-AF3.md`](docs/AGENT-FIRST-DECEPTION-AF3.md), [`docs/ADVERSARIAL-EPISTEMICS-AE0.md`](docs/ADVERSARIAL-EPISTEMICS-AE0.md), and [`docs/ADVERSARIAL-EPISTEMICS-AE1.md`](docs/ADVERSARIAL-EPISTEMICS-AE1.md) define the accepted boundary.

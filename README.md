...
- **Open research:** AF2 provides a physically consumed zero-or-more Range-intent surface without Contest ticks. AF3 separates communicated claim from complete independent truth. AE0 advances to an autonomous deceiver plus initially byte-identical partial evidence: the Defender preserves `UNKNOWN`, autonomously purchases inspection, and only then diverges into hold versus quarantine. This still does not force Trust/Reputation/Organization or a new communication core. Delayed/conflicting truth, repeated interaction, collusion, infection and strategic conflict remain higher-order consumers; witness freshness and stronger transaction/replication mechanisms stay parked until such a consumer forces them. [`docs/AGENT-FIRST-INTENT-AF2.md`](docs/AGENT-FIRST-INTENT-AF2.md), [`docs/AGENT-FIRST-DECEPTION-AF3.md`](docs/AGENT-FIRST-DECEPTION-AF3.md), and [`docs/ADVERSARIAL-EPISTEMICS-AE0.md`](docs/ADVERSARIAL-EPISTEMICS-AE0.md) define the accepted boundary.

...
- **Open research:** AF2 provides the reusable zero-or-more Range-intent surface. AF3 separates communicated claim from independent truth. AE0–AE2 establish information acquisition, costly waiting, and explicit adjudication under `UNKNOWN`. AE3 exposes unavoidable regret and an invented prior when adjudication disappears. AE3-B falsifies raw-history sufficiency; AE3-C shows exact reconstructable reduction stabilizes the tested consumer. EC0 then externalizes that reduction into a standalone committed program and reproduces the complete accepted AE3-C projections plus Agent-visible context digests under Runtime `contained_local` execution. A cross-domain audit finds Finance independently uses the same lower-level pattern with different PIT/materialization semantics, while World/Harness/Runtime/Computing do not force a universal reducer owner. The current pressure is therefore exact computation identity and later derivation freshness—not a Security Trust system or shared `EvidenceReducer` library. C1-O remains parked until an integrity-valid-but-stale derivation is physically consumed. [`docs/AGENT-FIRST-INTENT-AF2.md`](docs/AGENT-FIRST-INTENT-AF2.md), [`docs/AGENT-FIRST-DECEPTION-AF3.md`](docs/AGENT-FIRST-DECEPTION-AF3.md), [`docs/ADVERSARIAL-EPISTEMICS-AE0.md`](docs/ADVERSARIAL-EPISTEMICS-AE0.md), [`docs/ADVERSARIAL-EPISTEMICS-AE1.md`](docs/ADVERSARIAL-EPISTEMICS-AE1.md), [`docs/ADVERSARIAL-EPISTEMICS-AE2.md`](docs/ADVERSARIAL-EPISTEMICS-AE2.md), [`docs/ADVERSARIAL-EPISTEMICS-AE3.md`](docs/ADVERSARIAL-EPISTEMICS-AE3.md), [`docs/ADVERSARIAL-EPISTEMICS-AE3B.md`](docs/ADVERSARIAL-EPISTEMICS-AE3B.md), [`docs/ADVERSARIAL-EPISTEMICS-AE3C.md`](docs/ADVERSARIAL-EPISTEMICS-AE3C.md), and [`docs/EVIDENCE-COMPUTATION-EC0.md`](docs/EVIDENCE-COMPUTATION-EC0.md) define the current boundary.

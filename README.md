...
- **Open research:** AF2 provides the reusable zero-or-more Range-intent surface. AF3 separates communicated claim from independent truth. AE0–AE2 establish information acquisition, costly waiting, and explicit adjudication under `UNKNOWN`. AE3 removes adjudication and shows that identical evidence can force unavoidable counterfactual regret; the model also invents an unsupplied `50/50` prior. AE3-B then supplies raw independently adjudicated source history without Trust/Reputation scores and is falsified: history is sometimes used correctly, but aggregation is unstable, and one Agent explicitly argues for quarantine while its actual AF2 effect intent remains hold. The next pressure is therefore verifiable, reconstructable evidence reduction—not a Trust database. C1-O remains parked until stale-but-integrity-valid evidence appears. [`docs/AGENT-FIRST-INTENT-AF2.md`](docs/AGENT-FIRST-INTENT-AF2.md), [`docs/AGENT-FIRST-DECEPTION-AF3.md`](docs/AGENT-FIRST-DECEPTION-AF3.md), [`docs/ADVERSARIAL-EPISTEMICS-AE0.md`](docs/ADVERSARIAL-EPISTEMICS-AE0.md), [`docs/ADVERSARIAL-EPISTEMICS-AE1.md`](docs/ADVERSARIAL-EPISTEMICS-AE1.md), [`docs/ADVERSARIAL-EPISTEMICS-AE2.md`](docs/ADVERSARIAL-EPISTEMICS-AE2.md), [`docs/ADVERSARIAL-EPISTEMICS-AE3.md`](docs/ADVERSARIAL-EPISTEMICS-AE3.md), and [`docs/ADVERSARIAL-EPISTEMICS-AE3B.md`](docs/ADVERSARIAL-EPISTEMICS-AE3B.md) define the current boundary.

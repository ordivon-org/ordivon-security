...
- **Open research:** AF2 now provides a physically consumed zero-or-more Range-intent surface without Contest ticks. AF3 shows the first deception consumer can distinguish a communicated claim from independent world truth without forcing Trust/Reputation/Organization machinery. Active deception, partial truth, repeated interaction, collusion, infection and strategic conflict remain higher-order consumers; witness freshness and stronger transaction/replication mechanisms remain parked until such a consumer forces them. [`docs/AGENT-FIRST-INTENT-AF2.md`](docs/AGENT-FIRST-INTENT-AF2.md) and [`docs/AGENT-FIRST-DECEPTION-AF3.md`](docs/AGENT-FIRST-DECEPTION-AF3.md) define the accepted boundary.

...
_RESOLVE_PATH = Path("/mnt/c/Program Files/Blackmagic Design/DaVinci Resolve/Resolve.exe")
_INTL_PATH = Path("/mnt/c/Program Files/Blackmagic Design/DaVinci Resolve/intl.dll")
...
def collect_windows_host_resolve_baseline(
    ...
    if value.get("kind") != "ordivon.security.windows-host-resolve-free-baseline":
    ...
    receipt: JsonObject = {
        "schemaVersion": 1,
        "kind": "ordivon.security.windows-host-resolve-free-baseline-receipt",
